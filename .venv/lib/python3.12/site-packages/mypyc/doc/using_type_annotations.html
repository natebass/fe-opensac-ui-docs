...
<html lang="en" data-content_root="../../../../../../">
  <head>
    ...
    <title>Using type annotations &#8212; OpenSac UI 0.0.1 documentation</title>
...
<span id="id1"></span><h1>Using type annotations<a class="headerlink" href="#using-type-annotations" title="Link to this heading">¶</a></h1>
...
equally, however. Using types such as <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#primitive-types"><span class="std std-ref">primitive types</span></a>, <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#native-class-intro"><span class="std std-ref">native classes</span></a>,
<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#union-types"><span class="std std-ref">union types</span></a>, <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#trait-types"><span class="std std-ref">trait types</span></a>,
and <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#tuple-types"><span class="std std-ref">tuple types</span></a> as much as possible is a key to
...
<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#erased-types"><span class="std std-ref">erased types</span></a>.  Operations on erased types use
...
overhead (from compilation) and a bit of <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/differences_from_python.html#early-binding"><span class="std std-ref">early binding</span></a>, which will usually only give minor performance
gains.</p>
<section id="primitive-types">
<span id="id2"></span><h2>Primitive types<a class="headerlink" href="#primitive-types" title="Link to this heading">¶</a></h2>
...
implementations:</p>
<ul class="simple">
<li><p><code class="docutils literal notranslate"><span class="pre">int</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/int_operations.html#int-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">i64</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#native-ints"><span class="std std-ref">documentation</span></a>, <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/int_operations.html#int-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">i32</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#native-ints"><span class="std std-ref">documentation</span></a>, <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/int_operations.html#int-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">i16</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#native-ints"><span class="std std-ref">documentation</span></a>, <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/int_operations.html#int-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">u8</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#native-ints"><span class="std std-ref">documentation</span></a>, <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/int_operations.html#int-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">float</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/float_operations.html#float-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">bool</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/bool_operations.html#bool-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">str</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/str_operations.html#str-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">List[T]</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/list_operations.html#list-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">Dict[K,</span> <span class="pre">V]</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/dict_operations.html#dict-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">Set[T]</span></code> (<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/set_operations.html#set-ops"><span class="std std-ref">native operations</span></a>)</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">Tuple[T,</span> <span class="pre">...]</span></code> (variable-length tuple; <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/tuple_operations.html#tuple-ops"><span class="std std-ref">native operations</span></a>)</p></li>
...
<h2>Primitive containers<a class="headerlink" href="#primitive-containers" title="Link to this heading">¶</a></h2>
...
<span id="native-class-intro"></span><h2>Native classes<a class="headerlink" href="#native-classes" title="Link to this heading">¶</a></h2>
...
an <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/native_classes.html#inheritance"><span class="std std-ref">override</span></a> to allow that).</p>
<p>See <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/native_classes.html#native-classes"><span class="std std-ref">Native classes</span></a> for more details.</p>
</section>
<section id="tuple-types">
<span id="id3"></span><h2>Tuple types<a class="headerlink" href="#tuple-types" title="Link to this heading">¶</a></h2>
<p>Fixed-length
...
as <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#value-and-heap-types"><span class="std std-ref">value types</span></a> when stored in variables,
...
<span id="id5"></span><h2>Union types<a class="headerlink" href="#union-types" title="Link to this heading">¶</a></h2>
...
<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#erased-types"><span class="std std-ref">erased</span></a> items, accessing items with
non-erased types is often still quite efficient.</p>
<p>A value with a union types is always <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#value-and-heap-types"><span class="std std-ref">boxed</span></a>,
...
<span id="id7"></span><h2>Trait types<a class="headerlink" href="#trait-types" title="Link to this heading">¶</a></h2>
...
prevent it yet).</p></li>
<li><p>Traits can subclass other traits or native classes, but the MRO must be
linear (just like with native classes).</p></li>
...
<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#erased-types"><span class="std std-ref">erased types</span></a>.</p></li>
</ul>
...
<span id="id8"></span><h2>Erased types<a class="headerlink" href="#erased-types" title="Link to this heading">¶</a></h2>
...
<h2>Strict runtime type checking<a class="headerlink" href="#strict-runtime-type-checking" title="Link to this heading">¶</a></h2>
...
<span id="id9"></span><h2>Value and heap types<a class="headerlink" href="#value-and-heap-types" title="Link to this heading">¶</a></h2>
...
heap.  <code class="docutils literal notranslate"><span class="pre">bool</span></code>, <code class="docutils literal notranslate"><span class="pre">float</span></code>, <code class="docutils literal notranslate"><span class="pre">None</span></code>, <a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/using_type_annotations.html#native-ints"><span class="std std-ref">native integer types</span></a>
...
<span id="native-ints"></span><h2>Native integer types<a class="headerlink" href="#native-integer-types" title="Link to this heading">¶</a></h2>
...
<code class="docutils literal notranslate"><span class="pre">i32</span></code> (32-bit signed integer), <code class="docutils literal notranslate"><span class="pre">i16</span></code> (16-bit signed integer), and
<code class="docutils literal notranslate"><span class="pre">u8</span></code> (8-bit unsigned integer) if you know that integer values will
...
checks on operations. They may also use less memory than <code class="docutils literal notranslate"><span class="pre">int</span></code>
...
<a class="reference internal" href="../../../../../lib64/python3.12/site-packages/mypyc/doc/int_operations.html#int-ops"><span class="std std-ref">native integer operations</span></a>.</p>
</section>
</section>
...
<ul>
  <li><a href="../../../../../../index.html">Documentation overview</a><ul>
    ...
    <div class="footer">
      ...
      |
      <a href="../../../../../../_sources/.venv/lib/python3.12/site-packages/mypyc/doc/using_type_annotations.rst.txt"
